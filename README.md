...
> Spotted a bug or have an idea? [Open an issue](../../issues/new/choose) —
> I read every one.
...
|---|---|
| Something's broken | [Open an Issue](../../issues/new/choose) — Bug Report template |
| Feature idea | [Open an Issue](../../issues/new/choose) — Feature Request template |
| "How do I…?" question | [Discussions → Q&A](../../discussions/categories/q-a) |
| Want to show your config | [Discussions → Show & Tell](../../discussions/categories/show-and-tell) |
| General feedback / love | [Discussions → General](../../discussions/categories/general) or [Buy Me a Coffee](https://buymeacoffee.com/nathanieljiang) (it has a notes field 🙂) |
| Security issue | [Private security advisory](../../security/advisories/new) — see [SECURITY.md](SECURITY.md) |

I read every Issue and Discussion. Response time varies — I'm one person —
but nothing gets ignored. If something blocks you, drop a comment in your
existing thread instead of opening a duplicate.

Code contributions are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for
